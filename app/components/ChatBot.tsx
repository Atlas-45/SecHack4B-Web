...
[GK-014] 消失点
年: 2024 | タグ: Abstract
説明: 都市の中心で捉えた、存在と不在の境界線。密度の高い建築群の間から覗く空虚な空間が、見えないものの存在を強く意識させる。消失点へと収束する視線の先に、何かが待っている。

[GK-020] 光の搬送
年: 2024 | タグ: Industrial
説明: 深夜の工場地帯、絶え間なく動き続ける物流の現場。人工的な照明に照らし出された無機質な構造物と、そこで働く人々の気配を、冷たくも美しいトーンで表現。

[GK-009] 旧街区
年: 2022 | タグ: Landscape
説明: 再開発によって消えゆく古い街並み。朽ちかけた壁、錆びた看板、路地の奥の生活感。失われゆく昭和の面影を、記録として、そして記憶として留めるためのランドスケープ。
