...
const guidelines = [
  {
    title: "利用目的",
    text: "用途は報道・紹介目的に限ります。商業販売物への無断転載は固くお断りします。",
  },
  {
    title: "改変の禁止",
    text: "画像のトリミングや色味の変更は最小限でお願いします。作品の意図を損なわないよう配慮ください。",
  },
  {
    title: "クレジット",
    text: "「© GLASS KEY / ██████」といった形式でのクレジット表記を必須としています。",
  },
  {
    title: "事前確認",
    text: "大きなメディアでの掲載前には、事実確認のため必ず内容の校正をお願いしております。",
  },
];
